    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url().'admin/setting' ?>" class="dropdown-item">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="#" role="button"><i
            class="fas fa-user"></i></a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="dropdown-divider"></div>
          <a href="<?php echo base_url().'Member/login/logout' ?>" class="float-right dropdown-item">
            <i class="fas fa-envelope mx-auto"></i> Logout
            <span class="float-right text-muted text-sm"></span>
          </a>
        </div>
      </li>
