...
<body class="hold-transition layout-top-nav fixed">
    <div class="wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php foreach ($data->result_array() as $i) : ?>
                                <div class="card card-primary card-outline " style="width: 100%;">
                                    <div class="card-header">
                                        <h5 class="card-title m-0">Detail <?php echo $i['wisata_nama'] ?></h5>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table class="table table-bordered">
                                            <tbody>
                                                <tr>
                                                    <th width="150px">Nama Wisata</th>
                                                    <td width="20px">:</td>
                                                    <td><?php echo $i['wisata_nama'] ?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <th>Latitude</th>
                                                    <td width="20px">:</td>
                                                    <td><?php echo $i['wisata_latitude'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Longitude</th>
                                                    <td width="20px">:</td>
                                                    <td><?php echo $i['wisata_longitude'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Alamat</th>
                                                    <td width="20px">:</td>
                                                    <td><?php echo $i['wisata_alamat'] ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Deskripsi</th>
                                                    <td width="20px">:</td>
                                                    <td><?php echo $i['wisata_desc'] ?></td>
                                                </tr>
                                            </tbody>
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2014-2019 Geo Wisata</a>.</strong> All rights
            reserved.
        </footer>
        <!-- ./wrapper -->
