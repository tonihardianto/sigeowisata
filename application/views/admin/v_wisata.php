...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $key['wisata_nama']  ?></td>
                                                    <td><?php echo $key['kategori_nama'] ?></td>
                                                    <td><?php echo $key['wisata_longitude'] ?></td>
                                                    <td><?php echo $key['wisata_latitude'] ?></td>
                                                    <td style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'Admin/wisata/edit' ?>?id=<?php echo $key['wisata_id'] ?>" type="button" class="btn btn-xs btn-warning" title="Edit"><span class="fa fa-edit"></span> Edit</a>
        ...
        <div class="modal fade" id="myDelete<?php echo $d['wisata_id'] ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="post" action="<?php echo base_url() . 'Admin/wisata/delete'; ?>" id="form_sample_1" class="form-horizontal">
                        <div class="modal-body">
                            <p>Yakin ingin menghapus data <b><?php echo $d['wisata_nama'] ?></b>..?</p>
                            <input name="id" type="hidden" value="<?php echo $d['wisata_id']  ?>">
                            <!-- <input name="id1" type="hidden" value="<?php echo $d['wisata_id'] ?>"> -->
                        </div>
