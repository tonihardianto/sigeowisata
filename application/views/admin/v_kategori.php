...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align:center;">
                                                        <a href="#myEdit<?php echo $key['kategori_id'];  ?>" data-id="<?php ?>" type="button" class="btn btn-xs btn-warning" data-toggle="modal" data-target="" title="Edit"><span class="fa fa-edit"></span> Edit</a>
                                                        <a class="btn btn-xs btn-danger" href="#myDelete<?php echo $key['kategori_id']  ?>" data-toggle="modal" title="Hapus"><span class="fa fa-trash-alt"></span> Hapus</a>
        ...
        <!-- Begin Modal Edit -->
        <?php
        foreach ($kat->result_array() as $e) :
        ?>

            <div class="modal fade" id="myEdit<?php echo $e['kategori_id'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="<?php echo base_url() . 'Admin/kategori/editKat' ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-4 col-form-label">Nama Kategori </label>
                                        <div class="col-sm-10">
                                            <input type="hidden" class="form-control" name="id" id="inputEmail3" value="<?php echo $e['kategori_id'] ?>">
                                            <input type="text" class="form-control" name="nama" id="inputEmail3" value="<?php echo $e['kategori_nama'] ?>" placeholder="Kategori" required>
                                        </div>
                                    </div>
                                    <input type="hidden" class="form-control" name="icon" id="inputEmail3" value="<?php echo $e['kategori_marker'] ?>" placeholder="Kategori">
                                    <div class="form-group row">
                                        <label for="inputEmail3" class="col-sm-4 col-form-label">Marker (.png) </label>
                                        <div class="col-sm-10">
                                            <div class="custom-file">
                                                <input type="file" name="marker" class="custom-file-input" id="customFile" value="<?php echo $e['kategori_marker'] ?>">
                                                <label class="custom-file-label" for="customFile">Pilih Foto..</label>
                                            </div>
                                        </div>
                                    </div>
