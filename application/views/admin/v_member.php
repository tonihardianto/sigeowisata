...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo $key['member_username']; ?></td>
                                                    <td><?php echo $key['member_fullname']; ?></td>
                                                    <td><?php echo $key['member_phone']; ?></td>
                                                    <td><?php echo $key['member_email']; ?></td>
                                                    <td style="text-align:center;">
                                                        <a href="<?php echo base_url() . 'Admin/Wisata/byMember'; ?>?id=<?php echo $id ?>" type="button" class="btn btn-xs btn-info" title="View"><span class="fa fa-eye"></span> View</a>
        ...
        <!-- /.modal add -->
        <!-- Begin Modal Edit -->
        <?php foreach ($edit->result_array() as $key) :
            $id = $key['member_id'];
            $user = $key['member_username'];
            $pass = $key['member_password'];
            $name = $key['member_fullname'];
            $phone = $key['member_phone'];
            $mail = $key['member_email'];
        ?>
            ...
            <div class="modal fade" id="myDelete<?php echo $id; ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form method="post" action="<?php echo base_url() . 'admin/member/delMember'; ?>" id="form_sample_1" class="form-horizontal">
                            <div class="modal-body">
                                <p>Yakin ingin menghapus pengguna <b><?php echo $user; ?></b>..?</p>
                                <input name="id" type="hidden" value="<?php echo $id; ?>">
                            </div>
                            <div class="modal-footer justify-content-between">
