        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo base_url().'admin/penginapan' ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-default">
                                    ...
                                    <!-- /.card-header -->
                                    <form method="post" action="<?php echo base_url() . 'Admin/penginapan/editInap' ?>">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-6 col-form-label">Nama Penginapan</label>
                                                <div class="col-sm-11">
