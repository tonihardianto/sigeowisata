...
<body class="hold-transition sidebar-mini">
                        ...
                        <div class="col-md-6">
                            <div class="card card-default">
                                ...
                                <?php foreach ($data->result_array() as $ed) : ?>
                                    <form method="post" action="<?php echo base_url() . 'Member/wisata/editWisata' ?>">
                                        <div class="card-body">
                                            <div class="form-group row">
                                                <label for="inputEmail3" class="col-sm-6 col-form-label">Nama Wisata</label>
                                                <input type="hidden" name="id" value="<?php echo $ed['w_id'] ?>">
                                                <div class="col-sm-11">
                                                    <input type="text" class="form-control" name="wisata" id="wisata" placeholder="Nama Wisata" value="<?php echo $ed['w_nama'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-11">
                                                    <select class="form-control select" name="kategori" id="kategori">
                                                        ...
                                                        <?php $idkat = $ed['w_kategori'] ?>
                                                        <?php foreach ($kat->result_array() as $k) :
                                                            $katid = $k['kategori_id'];
                                                            $katname = $k['kategori_nama'];
                                                            if ($katid == $idkat)
                                                                echo "<option value='$katid' selected>$katname</option>";
                                                            else
                                                                echo "<option value='$katid'>$katname</option>";
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-11">
                                                    <input type="text" onkeypress="return numOnly(event)" maxlength="7" value="<?php echo $ed['w_tiket'] ?>" class="form-control" name="tiket" id="tiket" placeholder="Tiket Masuk" required>
                                                </div>
                                            </div>
                                            <!--<div class="form-group row">-->
                                            <!--    <label for="kabupaten" class="col-sm-6 col-form-label">Kabupaten</label>-->
                                            <!--    <div class="col-sm-11">-->
                                            <!--        <input type="text" class="form-control" name="kab" value="<?php echo $kab ?>" id="longitude" placeholder="Longitude">-->
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-11">
                                                    <input type="text" class="form-control" name="lng" id="longitude" value="<?php echo $ed['w_long'] ?>" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="latitude" class="col-sm-6 col-form-label">Latitude</label>
                                                <div class="col-sm-11">
                                                    <input type="text" class="form-control" name="lat" value="<?php echo $ed['w_lat'] ?>" id="latitude" placeholder="Latitude" required>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="alamat" class="col-sm-6 col-form-label">Alamat</label>
                                                <div class="col-sm-11">
                                                    <textarea class="form-control" name="alamat" id="alamat" cols="auto" rows="3"><?php echo $ed['w_alamat'] ?></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="alamat" class="col-sm-6 col-form-label">Deskripsi</label>
                                                <div class="col-sm-11">
                                                    <textarea class="textarea form-control" name="desc" id="desc" cols="auto" rows="3" required> <?php echo $ed['w_desc'] ?></textarea>
                                                </div>
                                            </div>

                                            <div class="card-footer">
                                                <a href="<?php echo base_url() . 'member/wisata' ?>" class="btn btn-default"> Kembali</a>
    ...
    <script>
        ...
        var kabupaten = new L.GeoJSON.AJAX("<?= base_url() ?>asset/geojson/yogyakarta.geojson").addTo(map);
