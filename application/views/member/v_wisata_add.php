        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="<?php echo base_url() . 'member/member' ?>" class="nav-link">Home</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-default">
                                ...
                                <!-- /.card-header -->
                                <form method="post" action="<?php echo base_url() . 'Member/wisata/add_wisata' ?>">
                                    <div class="card-body">

                                        <input type="hidden" name="id" id="id" value="<?php echo $this->session->userdata('member_id') ?>">
