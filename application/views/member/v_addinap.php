                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card card-default">
                                ...
                                <!-- /.card-header -->
                                <form method="post" action="<?php echo base_url() . 'Member/penginapan/addInap' ?>">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            <label for="inputEmail3" class="col-sm-6 col-form-label">Nama Wisata</label>
                                            <div class="col-sm-11">
                                                <input type="hidden" name="id" value="<?php echo $this->session->userdata('member_id'); ?>">
                                                <input type="text" class="form-control" name="nama" id="wisata" placeholder="Nama Penginapan" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-11">
                                                <textarea class="form-control" name="fasilitas" id="fasilitas" cols="auto" rows="3"></textarea>
                                        ...
                                        <div class="card-footer">
                                            <a href="<?php echo base_url() . 'Member/penginapan' ?>" class="btn btn-default"> Kembali</a>
