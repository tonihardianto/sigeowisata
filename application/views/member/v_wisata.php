...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <div class="btn-group">
                                        <a href="wisata/add"><button class="btn btn-primary">Tambah Wisata <i class="fas fa-plus"></i></button></a>
                                    </div>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                    <?php 
                                                    if ($stat=='Waiting') echo '<span class="badge badge-warning">'.$stat.'</span>';
                                                    elseif ($stat=='Approved') echo '<span class="badge badge-success">' . $stat . '</span>';
                                                    elseif ($stat == 'Rejected') echo '<span class="badge badge-danger">' . $stat . '</span>';
                                                    ?>
                                                    
                                                    </td>
                                                    <td style="text-align:center;">
                                                        <?php 
                                                        if ($stat=='Waiting') echo '<a class="btn btn-xs btn-danger" href="#myDelete'.$id.'" data-toggle="modal" title="Hapus"><span class="fa fa-trash-alt"></span> Hapus</a>
                                                        <a href="'.base_url() . 'Member/wisata/edit' .'?id='. $key['w_id'] .' type="button" class="btn btn-xs btn-warning" title="Edit"><span class="fa fa-edit"></span> Edit</a>'; 
                                                        elseif ($stat=='Rejected') echo '<a class="btn btn-xs btn-danger" href="#myDelete'.$id.'" data-toggle="modal" title="Hapus"><span class="fa fa-trash-alt"></span> Hapus</a>';
                                                        ?>
        ...
        <!-- End Modal edit -->
        <!-- Begin Modal hapus -->
        <?php foreach ($del->result_array() as $d) { ?>
            <div class="modal fade" id="myDelete<?php echo $d['w_id'] ?>">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <form method="post" action="<?php echo base_url() . 'Member/wisata/delete'; ?>" id="form_sample_1" class="form-horizontal">
                            <div class="modal-body">
                                <p>Yakin ingin menghapus data <b><?php echo $d['w_nama']  ?></b>..?</p>
                                <input name="id" type="hidden" value="<?php echo $d['w_id']  ?>">
                            </div>
                            <div class="modal-footer justify-content-between">
