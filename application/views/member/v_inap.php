    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="../../index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">Geo Wisata Jogja</span>
            </a>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        if ($stat=='Pending') echo '<span class="badge badge-warning">'.$key['inap_status'].'</span></td>';
                                                        elseif ($stat=='Rejected') echo '<span class="badge badge-danger">'.$key['inap_status'].'</span></td>';
                                                        elseif ($stat=='Approved') echo '<span class="badge badge-info">'.$key['inap_status'].'</span></td>';
                                                        
                                                        ?>
                                                    <td style="text-align:center;">
                                                    <?php 
                                                    if ($stat == 'Pending') echo '
                                                        <a href="'.base_url() . 'Member/penginapan/edit'.'?id='. $key['inap_id'].'" type="button" class="btn btn-xs btn-warning" title="Edit"><span class="fa fa-edit"></span> </a>
                                                        <a class="btn btn-xs btn-danger" href="#myDelete'. $id .'" data-toggle="modal" title="Hapus"><span class="fa fa-trash-alt"></span> </a>';
                                                    elseif($stat=='Rejected') echo '<a class="btn btn-xs btn-danger" href="#myDelete'. $id .'" data-toggle="modal" title="Hapus"><span class="fa fa-trash-alt"></span> </a>';
                                                    ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach ?>
        ...
        <div class="modal fade" id="myDelete<?php echo $key['inap_id']; ?>">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <form method="post" action="<?php echo base_url() . 'Member/penginapan/delete'; ?>" id="form_sample_1" class="form-horizontal">
                        <div class="modal-body">
